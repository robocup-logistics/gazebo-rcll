 ...
 */
void DepthCam::Load(sensors::SensorPtr _sensor, sdf::ElementPtr _sdf) 
{
  ...
  newRGBPointCloudConnection = depthCamera->ConnectNewRGBPointCloud(
      boost::bind(&DepthCam::OnNewRGBPointCloud,
        this, _1, _2, _3, _4, _5));
...
void DepthCam::OnNewDepthFrame(const float *_image,
 ...
 */
void DepthCam::OnNewRGBPointCloud(const float *_pcd,
				  unsigned int _width, unsigned int _height,
				  unsigned int _depth, const std::string &_format)
{
...
void DepthCam::OnNewImageFrame(const unsigned char *_image,
			       unsigned int _width, unsigned int _height,
			       unsigned int _depth, const std::string &_format)
{

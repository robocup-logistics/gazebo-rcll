...
#define TOPIC_SET_GAME_STATE \
	config->get_string("plugins/llsf-refbox-comm/topic-set-game-state").c_str()
#define TOPIC_SET_GAME_PHASE \
	config->get_string("plugins/llsf-refbox-comm/topic-set-game-phase").c_str()
#define TOPIC_SET_TEAM_NAME \
	config->get_string("plugins/llsf-refbox-comm/topic-set-team-name").c_str()
#define TOPIC_SET_MACHINE_STATE \
	config->get_string("plugins/llsf-refbox-comm/topic-set-machine-state").c_str()
#define TOPIC_MACHINE_REPLY \
	config->get_string("plugins/llsf-refbox-comm/topic-machine-reply").c_str()
#define TOPIC_MACHINE_ADD_BASE \
	config->get_string("plugins/llsf-refbox-comm/topic-machine-add-base").c_str()
#define TOPIC_SET_ORDER_DELIVERY_BY_COLOR \
	config->get_string("plugins/llsf-refbox-comm/topic-set-order-delivery-by-color").c_str()

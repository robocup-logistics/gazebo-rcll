...
void
MachineVision::create_publishers()
{
	this->light_signal_pub_ =
	  this->node->Advertise<llsf_msgs::AllMachineSignals>("~/RobotinoSim/MachineVision/");
}

void
MachineVision::create_subscribers()
{
	//no subscribers
}

void
MachineVision::update()
{

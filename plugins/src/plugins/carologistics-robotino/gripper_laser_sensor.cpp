 ...
 */
GripperLaserSensor::GripperLaserSensor(physics::ModelPtr  model,
...
void
GripperLaserSensor::init()
{
	printf("Initialize GripperLaserSensor \n");

	//Register OnNewLaserScans function
	this->new_laser_scans_connection_ = this->parent_sensor_->GetLaserShape()->ConnectNewLaserScans(
	  boost::bind(&GripperLaserSensor::on_new_laser_scans, this));
}

void
GripperLaserSensor::create_publishers()
{
	switch (side_) {
	case LEFT: {
		this->gripper_laser_sensor_pub_ =
		  this->node->Advertise<gazsim_msgs::Float>("~/RobotinoSim/GripperLaserSensor/Left/");
		break;
	}
	case RIGHT: {
		this->gripper_laser_sensor_pub_ =
		  this->node->Advertise<gazsim_msgs::Float>("~/RobotinoSim/GripperLaserSensor/Right/");
		break;
	}
	}
}
...
void
GripperLaserSensor::create_subscribers()
{
}

void
GripperLaserSensor::update()
{
	//sending the laser scans happens in OnNewLaserScans()
}

void
GripperLaserSensor::on_new_laser_scans()
{

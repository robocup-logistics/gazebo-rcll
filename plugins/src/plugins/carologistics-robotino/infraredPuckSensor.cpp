 ...
 */
InfraredPuckSensor::InfraredPuckSensor(physics::ModelPtr  model,
...
InfraredPuckSensor::init()
{
	...
	this->new_laser_scans_connection_ = this->parent_sensor_->GetLaserShape()->ConnectNewLaserScans(
	  boost::bind(&InfraredPuckSensor::on_new_laser_scans, this));
}

void
InfraredPuckSensor::create_publishers()
{
	this->infrared_puck_sensor_pub_ =
	  this->node->Advertise<gazsim_msgs::Float>("~/RobotinoSim/InfraredPuckSensor/");
}

void
InfraredPuckSensor::create_subscribers()
{
}

void
InfraredPuckSensor::update()
{
	//sending the laser scans happens in OnNewLaserScans()
}

void
InfraredPuckSensor::on_new_laser_scans()
{

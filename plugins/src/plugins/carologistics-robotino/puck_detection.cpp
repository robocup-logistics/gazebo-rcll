...
void
PuckDetection::create_publishers()
{
	this->puck_position_pub_ =
	  this->node->Advertise<llsf_msgs::PuckDetectionResult>("~/RobotinoSim/PuckDetectionResult/");
}

void
PuckDetection::create_subscribers()
{
	//no subscribers
}

void
PuckDetection::update()
{
...
void
PuckDetection::send_puck_positions()
{

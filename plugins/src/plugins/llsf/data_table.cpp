 ...
 */
void
LlsfDataTable::init(physics::WorldPtr world, transport::NodePtr gazebo_node)
{
	if (!table_) {
 ...
 */
Machine
LlsfDataTable::get_machine(MachineName name)
{
 ...
 */
Machine
LlsfDataTable::get_machine(std::string machine)
{
	for (int i = M1; i <= R2; i++) {
 ...
 */
Puck
LlsfDataTable::get_puck(int number)
{
 ...
 */
void
LlsfDataTable::set_light_state(MachineName machine,
                               LightState  red,
                               LightState  yellow,
                               LightState  green)
{
 ...
 */
void
LlsfDataTable::set_light_state(std::string machine,
                               LightState  red,
                               LightState  yellow,
                               LightState  green)
{
 ...
 */
void
LlsfDataTable::set_machine_team(std::string machine, Team team)
{
	for (int i = M1; i <= R2; i++) {
		//is it the right machine?
		if (machines_[i].name_string.find(machine) == 0) {
 ...
 */
void
LlsfDataTable::set_puck_pos(int puck, double x, double y)
{
	pucks_[puck].x = x;
	pucks_[puck].y = y;
}
 ...
 */
void
LlsfDataTable::set_puck_under_rfid(int puck, MachineName machine)
{
 ...
 */
void
LlsfDataTable::remove_puck_under_rfid(int puck, MachineName machine)
{
 ...
 */
void
LlsfDataTable::set_puck_in_machine_area(int puck, MachineName machine)
{
 ...
 */
void
LlsfDataTable::set_puck_state(int puck, llsf_msgs::PuckState state)
{
	pucks_[puck].state = state;
}

void
LlsfDataTable::init_table()
{
...
void
LlsfDataTable::init_machine(MachineName number, std::string name_link, std::string name_string)
{
...
void
LlsfDataTable::init_puck(int number, std::string name)
{

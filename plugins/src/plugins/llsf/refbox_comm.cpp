...
RefboxComm::RefboxComm(LlsfDataTable *table, transport::NodePtr gazebo_node)
{
	...
	//create subscriber
	this->machine_info_sub_ = gazebo_node_->Subscribe(std::string("~/LLSFRbSim/MachineInfo/"),
	                                                  &RefboxComm::on_machine_info_msg,
	                                                  this);
	this->puck_info_sub_    = gazebo_node_->Subscribe(std::string("~/LLSFRbSim/PuckInfo/"),
                                                 &RefboxComm::on_puck_info_msg,
                                                 this);
}
 ...
 */
void
RefboxComm::send_puck_placed_under_rfid(int puck, Machine &machine)
{
	//create the message
 ...
 */
void
RefboxComm::send_remove_puck_from_machine(int puck, Machine &machine)
{
	//create the message
...
void
RefboxComm::on_machine_info_msg(ConstMachineInfoPtr &msg)
{
...
void
RefboxComm::on_puck_info_msg(ConstPuckInfoPtr &msg)
{
	//printf("Got PuckInfo\n");
